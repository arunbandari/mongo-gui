...
let ApiService = class ApiService {
    ...
    filterDocumentsByQuery(dbName, collectionName, query, pageIndex = 1) {
        return this.http.post(`http://localhost:3000/databases/${dbName}/collections/${collectionName}/documents/filter?limit=25&skip=${(pageIndex -
            1) *
            25}&ContentType=bson`, query);
    }
    ...
    updateDocument(dbName, collectionName, document) {
        return this.http.patch(`http://localhost:3000/databases/${dbName}/collections/${collectionName}/documents?incomingType=bson`, document);
    }
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".container {\n  padding: 8px 10px;\n  overflow: auto;\n  height: calc(100vh - 140px);\n  background: #f5f5f5;\n}\n.document {\n  display: grid;\n  grid-template-columns: 9fr 3fr;\n  border: 1px solid #ddd;\n  background-color: #ffffff;\n  padding: 15px 8px;\n  margin-bottom: 8px;\n  /* box-shadow: 0px 2px 1px -1px rgba(0, 0, 0, 0.2),\n    0px 1px 1px 0px rgba(0, 0, 0, 0.14), 0px 1px 3px 0px rgba(0, 0, 0, 0.12) !important; */\n}\n.right [nz-button] {\n  margin: 0px 4px !important;\n  height: 25px;\n  width: 25px;\n}\n.document .right [nz-button] {\n  visibility: hidden;\n}\n.document:hover .right [nz-button] {\n  visibility: visible;\n}\n.query {\n  padding: 0px 10px;\n}\n.query [nz-input] {\n  background: whitesmoke;\n}\n.help {\n  border-bottom: 2px solid #ddd;\n  padding-bottom: 5px;\n}\n.tab_content {\n  grid-template-rows: auto;\n}\n.meta {\n  list-style-type: none;\n  display: -webkit-inline-box;\n  display: inline-flex;\n  padding: 0;\n}\n.meta li {\n  padding: 0px 15px;\n  vertical-align: middle;\n  line-height: 30px;\n}\n.bar {\n  display: grid;\n  grid-template-columns: 4fr 2fr;\n}\n.loader {\n  top: 100px;\n  position: relative;\n}\n.footer {\n  position: absolute;\n  bottom: 0px;\n  width: 100%;\n  border-top: 1px solid rgb(232, 232, 232);\n  padding: 10px 16px;\n  text-align: right;\n  left: 0px;\n  background: #fff;\n}\n.error_info {\n  margin-bottom: 20px;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */");
...
let CollectionRendererComponent = class CollectionRendererComponent {
    ...
    query() {
        try {
            ...
            this.API.filterDocumentsByQuery(this.database, this.collection, filter, this.pageIndex).subscribe((documents) => {
                this.loading = false;
                this.data = Object(bson__WEBPACK_IMPORTED_MODULE_4__["deserialize"])(Buffer.from(documents.data));
    ...
    updateDocument() {
        try {
            ...
            this.error.desc = '';
            const orignalDocument = Object(bson__WEBPACK_IMPORTED_MODULE_4__["serialize"])(bson__WEBPACK_IMPORTED_MODULE_4__["EJSON"].deserialize(JSON.parse(this.documentBeingEdited)));
            this.API.updateDocument(this.database, this.collection, orignalDocument).subscribe(response => {
...
let SidenavComponent = class SidenavComponent {
    ...
    openCollection(event, dbName, collectionName) {
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], SidenavComponent.prototype, "dbs", void 0);
