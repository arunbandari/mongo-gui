  ...
  function srcAppApiServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(ApiService, [{
        ...
        key: "updateDocument",
        value: function updateDocument(dbName, collectionName, document) {
          return this.http.patch("http://localhost:3000/databases/".concat(dbName, "/collections/").concat(collectionName, "/documents?incomingType=bson"), document);
        }
      }]);
      ...
      _createClass(CollectionRendererComponent, [{
        ...
        value: function updateDocument() {
          ...
          try {
            ...
            this.error.desc = '';
            var orignalDocument = Object(bson__WEBPACK_IMPORTED_MODULE_4__["serialize"])(bson__WEBPACK_IMPORTED_MODULE_4__["EJSON"].deserialize(JSON.parse(this.documentBeingEdited)));
            this.API.updateDocument(this.database, this.collection, orignalDocument).subscribe(function (response) {
