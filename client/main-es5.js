    ...
    function () {
      ...
      _createClass(ApiService, [{
        ...
        value: function filterDocumentsByQuery(dbName, collectionName, query) {
          return this.http.post("http://localhost:3000/databases/".concat(dbName, "/collections/").concat(collectionName, "/documents/filter"), query);
        }
      }, {
  ...
  function srcAppCollectionRendererCollectionRendererComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(CollectionRendererComponent, [{
        ...
        key: "query",
        value: function query(criteria) {
          var _this3 = this;

          try {
            if (!criteria) criteria = {};else criteria = JSON.parse(criteria);
            this.API.filterDocumentsByQuery(this.database, this.collection, criteria).subscribe(function (documents) {
        ...
        value: function deleteDocument(id) {
          ...
          this.API.deleteDocumentById(this.database, this.collection, id).subscribe(function (response) {
            _this4.query({});
          });
        }
      }, {
